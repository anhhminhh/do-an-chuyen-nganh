    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <div class="card-footer">
                            <a href="taomoi_danhmuc_baiviet.php"> <button type="submit" class="btn btn-primary"> <i class="fas fa-user-plus"></i> Tạo mới danh mục </button></a>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title" style="color: red">Danh mục bài viết</h>
                </div>
                <!-- /.card-header -->
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            <tr role="row" class="odd">
                                ...
                                <td>Tin tức</td>
                                <td ><a href="taomoi_sanpham.php"> <button type="submit" class="btn btn-primary1" style="background: #7B68EE"> <i class="fas fa-plus"></i> &nbsp; Thêm bài viết</button></a> </td>
                                ...
                                <td ><a href="taomoi_sanpham.php"> <button type="submit" class="btn btn-primary1" style="background: #7B68EE"> <i class="fas fa-plus"></i></i> &nbsp; Thêm bài viết</button></a> </td>
                                <td ><a href="#"> <button type="submit" class="btn btn-primary1"> <i class="fas fa-edit"></i> &nbsp; Sửa</button></a> </td>
                                <td ><a href="#"> <button type="submit" class="btn btn-primary1" style="background: #FFA500"> <i class="fas fa-trash-alt"></i> &nbsp;  Xoá</button></a> </td>
